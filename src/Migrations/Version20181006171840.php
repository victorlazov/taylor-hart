 ...
 */
final class Version20181006171840 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE course_page_views (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, course_id VARCHAR(255) NOT NULL, timestamp INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE course_page_views');
    }
}
